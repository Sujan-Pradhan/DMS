						...
						<div class="row">
							<div class="col-md-6">
								...
								if(isset($_POST['upload'])) {
									...
									if(empty($img)) {
										...
										$query = "update patient set profile='$img' where username='$pat'";
							...
							<div class="col-md-6">
								...
								if(isset($_POST['update_pass'])) {
									...
									$ol = mysqli_query($conn, "SELECT * FROM doctor WHERE username='$pat'");
									...
									if(empty($old)) {
										...
										if(count($error)==0) {
											$query = "UPDATE patient SET password='$new' WHERE username='$pat'";
