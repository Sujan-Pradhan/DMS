				...
				<div class="col-md-10">
					...
					if(isset($_POST['book'])) {
						...
						if(empty($sym)) {
							...
							$query = "INSERT INTO appointment(firstname,surname,gender,phone,appointment_date,symptoms,status,booked_date)VALUES('$firstname','$surname','$gender','$phone','$date','$sym','pending',NOW())";
