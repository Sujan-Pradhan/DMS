...
<div class="container">
	<div class="col-md-12">
		...
		<div class="col-md-3 mx-1 shadow">
			<img src="img/info.jpg" style="width: 100%; height: 315px;">
		...
		<div class="col-md-4 mx-1 shadow">
			<img src="img/patient.jpg" style="width: 100%; height: 315px">
		...
		<div class="col-md-4 mx-1 shadow">
			...
			<h5 class="text-center">We are employing for doctor</h5>
